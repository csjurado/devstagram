    ...
    <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl">
        <form action="{{route('register')}}" method="POST" novalidate>
            ...
            <div class="mb-5 ">
                ...
                {{-- ?Este es el input del nombre de usuario  --}}
            <div class="mb-5">
            ...
            {{-- ?Este es el input del Repetirpassword  --}}
            <div class="mb-5">
                <label for="password_confirmation" class="mb-2 block uppercase text-gray-500 font-bold"> 
                    Repetir Password 
                </label>
                <input id="password_confirmation" name="password_confirmation" type="password" placeholder="Confirmacion del Password de Registro " class="border p-3 w-full rounded-lg"/>
            </div>
            <div class="mb-5"></div>
